...
Platform-specific structure and conventions for writing guides, cheatsheets, and educational long-form content. Voice rules are handled separately by the `creator-stack:voice` skill — this file covers structure only.
