...
Generate 8 style board elements using the **creator-stack:nanobanana** skill. Build prompts using the templates and best practices from [references/prompt-engineering.md](references/prompt-engineering.md).
